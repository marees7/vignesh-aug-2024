...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Vigneshwartt",
            "url": "https://github.com/marees7/vignesh-aug-2024",
            "email": "vigneshwart2002@gmail.com"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
        ...
        "/posts": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search by job_role",
                        "name": "job_role",
                        "in": "query"
                    },
                    {
        ...
        "/v1/admin": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search by Job Role",
                        "name": "job_role",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.JobCreation"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/admin/jobs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search by jobRole",
                        "name": "job_role",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Search by jobId",
                        "name": "job_id",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ApplicantDetail"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/v1/user": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "UserJobs",
                        "name": "user",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UserJobDetails"
                        }
                    }
                ],
                "responses": {
