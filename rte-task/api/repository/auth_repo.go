...
func (database *AuthRepo) GetUserMail(userEmail string) *models.ErrorResponse {
	var count int64
...
func (database *AuthRepo) GetUserPhoneNumber(userPhoneNumber string) *models.ErrorResponse {
	var count int64
